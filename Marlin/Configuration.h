...
#define X_HOME_POS 0
#define Y_HOME_POS 0
#define Z_HOME_POS 353 // Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {53.333, 53.333, 53.333, 284.0}  // default steps per unit for rostockmax
